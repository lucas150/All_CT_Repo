...
public class MainActivity extends AppCompatActivity
        ...
        private void Utils.haptic(View v) {
        ...
        private void bindButtons() {
                ...
                findViewById(R.id.btnCustomInbox)
                                .setOnClickListener(v -> startActivity(new Intent(this, CustomInbox.class)));

                findViewById(R.id.btnPushTemplates)
                                .setOnClickListener(v -> startActivity(new Intent(this, PushTemplatesActivity.class)));
                ...
                findViewById(R.id.btnEvents)
                                .setOnClickListener(v -> startActivity(new Intent(this, EventsActivity.class)));

                findViewById(R.id.btnLogs)
                                .setOnClickListener(v -> startActivity(new Intent(this, LogActivity.class)));
        }
