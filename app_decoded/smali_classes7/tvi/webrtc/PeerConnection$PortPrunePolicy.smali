...
.method static constructor <clinit>()V
    ...
    .line 418
    new-instance v1, Ltvi/webrtc/PeerConnection$PortPrunePolicy;

    const-string v2, "PRUNE_BASED_ON_PRIORITY"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Ltvi/webrtc/PeerConnection$PortPrunePolicy;-><init>(Ljava/lang/String;I)V

    sput-object v1, Ltvi/webrtc/PeerConnection$PortPrunePolicy;->PRUNE_BASED_ON_PRIORITY:Ltvi/webrtc/PeerConnection$PortPrunePolicy;

    .line 419
    new-instance v2, Ltvi/webrtc/PeerConnection$PortPrunePolicy;

    const-string v3, "KEEP_FIRST_READY"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Ltvi/webrtc/PeerConnection$PortPrunePolicy;-><init>(Ljava/lang/String;I)V

    sput-object v2, Ltvi/webrtc/PeerConnection$PortPrunePolicy;->KEEP_FIRST_READY:Ltvi/webrtc/PeerConnection$PortPrunePolicy;

    .line 416
    filled-new-array {v0, v1, v2}, [Ltvi/webrtc/PeerConnection$PortPrunePolicy;
