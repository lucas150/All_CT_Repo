...
.method public static silentParametersFromInteractive(Lcom/microsoft/identity/client/AcquireTokenParameters;Lcom/microsoft/identity/common/java/result/ILocalAuthenticationResult;)Lcom/microsoft/identity/client/AcquireTokenSilentParameters;
    ...
    .line 39
    invoke-virtual {p0}, Lcom/microsoft/identity/client/AcquireTokenParameters;->getAuthority()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/microsoft/identity/client/AcquireTokenSilentParameters$Builder;->fromAuthority(Ljava/lang/String;)Lcom/microsoft/identity/client/TokenParameters$Builder;
    ...
    .line 40
    invoke-virtual {p0}, Lcom/microsoft/identity/client/AcquireTokenParameters;->getClaimsRequest()Lcom/microsoft/identity/client/claims/ClaimsRequest;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/microsoft/identity/client/AcquireTokenSilentParameters$Builder;->withClaims(Lcom/microsoft/identity/client/claims/ClaimsRequest;)Lcom/microsoft/identity/client/TokenParameters$Builder;
    ...
    .line 41
    invoke-virtual {p0}, Lcom/microsoft/identity/client/AcquireTokenParameters;->getScopes()Ljava/util/List;

    move-result-object p0

    invoke-virtual {v0, p0}, Lcom/microsoft/identity/client/AcquireTokenSilentParameters$Builder;->withScopes(Ljava/util/List;)Lcom/microsoft/identity/client/TokenParameters$Builder;
    ...
    .line 42
    invoke-virtual {p0, p1}, Lcom/microsoft/identity/client/AcquireTokenSilentParameters$Builder;->forAccount(Lcom/microsoft/identity/client/IAccount;)Lcom/microsoft/identity/client/TokenParameters$Builder;
