...
.field private chooserActivity:Landroid/app/Activity;
...
.method constructor <init>(Landroid/app/Activity;Lcom/codekidlabs/storagechooser/models/Config;)V
    ...
    .line 41
    invoke-direct {p0, p1}, Lcom/codekidlabs/storagechooser/StorageChooser;->setChooserActivity(Landroid/app/Activity;)V

    return-void
.end method

.method static synthetic access$000(Lcom/codekidlabs/storagechooser/StorageChooser;)Ljava/lang/String;
    .locals 0
...
.method private getChooserActivity()Landroid/app/Activity;
    .locals 1

    .line 126
    iget-object v0, p0, Lcom/codekidlabs/storagechooser/StorageChooser;->chooserActivity:Landroid/app/Activity;

    return-object v0
.end method

.method private getDefaultMultipleSelectionListener()Lcom/codekidlabs/storagechooser/StorageChooser$OnMultipleSelectListener;
    .locals 1

    .line 152
    new-instance v0, Lcom/codekidlabs/storagechooser/StorageChooser$3;

    invoke-direct {v0, p0}, Lcom/codekidlabs/storagechooser/StorageChooser$3;-><init>(Lcom/codekidlabs/storagechooser/StorageChooser;)V

    return-object v0
.end method

.method private getDefaultOnCancelListener()Lcom/codekidlabs/storagechooser/StorageChooser$OnCancelListener;
    .locals 1

    .line 143
    new-instance v0, Lcom/codekidlabs/storagechooser/StorageChooser$2;

    invoke-direct {v0, p0}, Lcom/codekidlabs/storagechooser/StorageChooser$2;-><init>(Lcom/codekidlabs/storagechooser/StorageChooser;)V

    return-object v0
.end method

.method private getDefaultOnSelectListener()Lcom/codekidlabs/storagechooser/StorageChooser$OnSelectListener;
    .locals 1

    .line 134
    new-instance v0, Lcom/codekidlabs/storagechooser/StorageChooser$1;

    invoke-direct {v0, p0}, Lcom/codekidlabs/storagechooser/StorageChooser$1;-><init>(Lcom/codekidlabs/storagechooser/StorageChooser;)V

    return-object v0
.end method

.method private static getStorageChooserDialog(Landroid/app/Activity;)Landroid/app/Dialog;
    .locals 2
...
.method private init()V
    ...
    .line 74
    invoke-direct {p0}, Lcom/codekidlabs/storagechooser/StorageChooser;->getChooserActivity()Landroid/app/Activity;

    move-result-object v0

    invoke-static {v0}, Lcom/codekidlabs/storagechooser/StorageChooser;->getStorageChooserDialog(Landroid/app/Activity;)Landroid/app/Dialog;
    ...
    .line 78
    invoke-direct {p0}, Lcom/codekidlabs/storagechooser/StorageChooser;->getDefaultOnSelectListener()Lcom/codekidlabs/storagechooser/StorageChooser$OnSelectListener;
    ...
    .line 81
    invoke-direct {p0}, Lcom/codekidlabs/storagechooser/StorageChooser;->getDefaultOnCancelListener()Lcom/codekidlabs/storagechooser/StorageChooser$OnCancelListener;
    ...
    .line 84
    invoke-direct {p0}, Lcom/codekidlabs/storagechooser/StorageChooser;->getDefaultMultipleSelectionListener()Lcom/codekidlabs/storagechooser/StorageChooser$OnMultipleSelectListener;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/codekidlabs/storagechooser/fragments/ChooserDialogFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V

    :goto_0
    return-void
.end method

.method private setChooserActivity(Landroid/app/Activity;)V
    .locals 0
...
.method public show()V
    ...
    .line 67
    invoke-direct {p0}, Lcom/codekidlabs/storagechooser/StorageChooser;->init()V
