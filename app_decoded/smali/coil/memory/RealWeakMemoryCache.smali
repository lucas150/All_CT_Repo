...
.method public final cleanUp$coil_base_release()V
    ...
    invoke-virtual {v1}, Lcoil/memory/RealWeakMemoryCache$WeakValue;->getBitmap()Ljava/lang/ref/WeakReference;
    ...
    .line 173
    :cond_2
    sget-object v2, Lcoil/memory/RealWeakMemoryCache$cleanUp$1;->INSTANCE:Lcoil/memory/RealWeakMemoryCache$cleanUp$1;
...
.method public declared-synchronized trimMemory(I)V
    ...
    .line 143
    :try_start_0
    iget-object v1, p0, Lcoil/memory/RealWeakMemoryCache;->logger:Lcoil/util/Logger;

    if-eqz v1, :cond_0

    const-string v2, "RealWeakMemoryCache"
    ...
    invoke-interface {v1, v2, v4, v0, v3}, Lcoil/util/Logger;->log(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
