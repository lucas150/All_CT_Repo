...
.method private final declared-synchronized hasAvailableFileDescriptors(Lcoil/util/Logger;)Z
    ...
    .line 76
    :try_start_0
    sget v1, Lcoil/memory/LimitedFileDescriptorHardwareBitmapService;->decodesSinceLastFileDescriptorCheck:I

    add-int/lit8 v2, v1, 0x1

    sput v2, Lcoil/memory/LimitedFileDescriptorHardwareBitmapService;->decodesSinceLastFileDescriptorCheck:I
    ...
    .line 79
    sget-object v2, Lcoil/memory/LimitedFileDescriptorHardwareBitmapService;->fileDescriptorList:Ljava/io/File;
    ...
    .line 82
    sget-boolean v1, Lcoil/memory/LimitedFileDescriptorHardwareBitmapService;->hasAvailableFileDescriptors:Z

    if-eqz v1, :cond_2

    if-eqz p1, :cond_2

    const-string v1, "LimitedFileDescriptorHardwareBitmapService"
