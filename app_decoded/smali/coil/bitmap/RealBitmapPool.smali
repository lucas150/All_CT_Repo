...
.method public synthetic constructor <init>(ILjava/util/Set;Lcoil/bitmap/BitmapPoolStrategy;Lcoil/util/Logger;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    check-cast p5, Lcoil/util/Logger;
...
.method private final declared-synchronized trimToSize(I)V
    ...
    invoke-interface {p1, v0, v3, v2, v1}, Lcoil/util/Logger;->log(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v2, v3, v5, v4, v1}, Lcoil/util/Logger;->log(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method public declared-synchronized getDirtyOrNull(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 99
    iget-object v2, p0, Lcoil/bitmap/RealBitmapPool;->strategy:Lcoil/bitmap/BitmapPoolStrategy;

    invoke-interface {v2, p1, p2, p3}, Lcoil/bitmap/BitmapPoolStrategy;->get(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 101
    iget-object v5, p0, Lcoil/bitmap/RealBitmapPool;->logger:Lcoil/util/Logger;

    if-eqz v5, :cond_0

    const-string v6, "RealBitmapPool"
    ...
    invoke-interface {v1, p1, p2, p3}, Lcoil/bitmap/BitmapPoolStrategy;->stringify(IILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
    ...
    invoke-interface {v5, v6, v4, v1, v3}, Lcoil/util/Logger;->log(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    iput v1, p0, Lcoil/bitmap/RealBitmapPool;->misses:I
    ...
    invoke-static {v2}, Lcoil/util/-Bitmaps;->getAllocationByteCountCompat(Landroid/graphics/Bitmap;)I
    ...
    iput v1, p0, Lcoil/bitmap/RealBitmapPool;->hits:I

    .line 107
    invoke-direct {p0, v2}, Lcoil/bitmap/RealBitmapPool;->normalize(Landroid/graphics/Bitmap;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcoil/bitmap/BitmapPoolStrategy;->stringify(IILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
    ...
    invoke-interface {v1, v5, v4, p1, v3}, Lcoil/util/Logger;->log(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized put(Landroid/graphics/Bitmap;)V
    ...
    const-string v1, "Put bitmap="

    const-string v2, ", is greater than max size: "

    const-string v3, "Rejecting duplicate bitmap from pool; bitmap: "

    const-string v4, ", is mutable: "

    const-string v5, "Rejecting bitmap from pool; bitmap: "

    const-string v6, "Rejecting recycled bitmap from pool; bitmap: "
    ...
    invoke-interface {v0, v1, v8, p1, v9}, Lcoil/util/Logger;->log(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v7, p0, Lcoil/bitmap/RealBitmapPool;->allowedConfigs:Ljava/util/Set;
    ...
    .line 65
    :cond_2
    iget-object v0, p0, Lcoil/bitmap/RealBitmapPool;->bitmaps:Ljava/util/HashSet;
    ...
    iget-object v3, p0, Lcoil/bitmap/RealBitmapPool;->strategy:Lcoil/bitmap/BitmapPoolStrategy;

    invoke-interface {v3, p1}, Lcoil/bitmap/BitmapPoolStrategy;->stringify(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1}, Lcoil/bitmap/BitmapPoolStrategy;->put(Landroid/graphics/Bitmap;)V
    ...
    iput v0, p0, Lcoil/bitmap/RealBitmapPool;->currentSize:I
    ...
    invoke-interface {v1, p1}, Lcoil/bitmap/BitmapPoolStrategy;->stringify(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    invoke-interface {v0, v2, v11, p1, v9}, Lcoil/util/Logger;->log(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 58
    iget v4, p0, Lcoil/bitmap/RealBitmapPool;->maxSize:I
    ...
    .line 59
    iget-object v2, p0, Lcoil/bitmap/RealBitmapPool;->allowedConfigs:Ljava/util/Set;
    ...
    invoke-interface {v1, v3, v11, v0, v9}, Lcoil/util/Logger;->log(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method public declared-synchronized trimMemory(I)V
    ...
    invoke-interface {v1, v3, v2, v0, v4}, Lcoil/util/Logger;->log(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
