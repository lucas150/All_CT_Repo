...
.method public declared-synchronized decrement(Landroid/graphics/Bitmap;)Z
    ...
    .line 77
    invoke-direct {p0, v2, p1}, Lcoil/bitmap/RealBitmapReferenceCounter;->getValueOrNull(ILandroid/graphics/Bitmap;)Lcoil/bitmap/RealBitmapReferenceCounter$Value;
    ...
    .line 81
    invoke-virtual {v3}, Lcoil/bitmap/RealBitmapReferenceCounter$Value;->getCount()I

    move-result v1

    add-int/lit8 v1, v1, -0x1

    invoke-virtual {v3, v1}, Lcoil/bitmap/RealBitmapReferenceCounter$Value;->setCount(I)V
    ...
    const-string v7, "RealBitmapReferenceCounter"
    ...
    invoke-virtual {v3}, Lcoil/bitmap/RealBitmapReferenceCounter$Value;->isValid()Z
    ...
    invoke-interface {v1, v7, v5, v0, v4}, Lcoil/util/Logger;->log(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0, v2}, Landroidx/collection/SparseArrayCompat;->remove(I)V
    ...
    const-string v0, "RealBitmapReferenceCounter"
    ...
    invoke-interface {p1, v0, v5, v1, v4}, Lcoil/util/Logger;->log(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    :try_end_1
...
.method public declared-synchronized increment(Landroid/graphics/Bitmap;)V
    ...
    .line 68
    invoke-direct {p0, v1, p1}, Lcoil/bitmap/RealBitmapReferenceCounter;->getValue(ILandroid/graphics/Bitmap;)Lcoil/bitmap/RealBitmapReferenceCounter$Value;
    ...
    invoke-virtual {p1, v2}, Lcoil/bitmap/RealBitmapReferenceCounter$Value;->setCount(I)V

    .line 70
    iget-object v2, p0, Lcoil/bitmap/RealBitmapReferenceCounter;->logger:Lcoil/util/Logger;

    if-eqz v2, :cond_0

    const-string v3, "RealBitmapReferenceCounter"
    ...
    invoke-interface {v2, v3, v5, p1, v0}, Lcoil/util/Logger;->log(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
