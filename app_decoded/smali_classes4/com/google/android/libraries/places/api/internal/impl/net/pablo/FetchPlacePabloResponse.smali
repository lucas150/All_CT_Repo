...
.method public final bridge synthetic convert()Lcom/google/android/libraries/places/internal/ay;
    ...
    .line 10
    invoke-virtual {p0}, Lcom/google/android/libraries/places/api/internal/impl/net/pablo/FetchPlacePabloResponse;->convert()Lcom/google/android/libraries/places/internal/em;
...
.method public final convert()Lcom/google/android/libraries/places/internal/em;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/gms/common/api/ApiException;
    ...
    invoke-static {v0, v1}, Lcom/google/android/libraries/places/internal/ao;->a(Lcom/google/android/libraries/places/api/internal/impl/net/pablo/PlaceResult;Ljava/util/List;)Lcom/google/android/libraries/places/internal/dl;

    move-result-object v0

    .line 8
    new-instance v1, Lcom/google/android/libraries/places/internal/ea;

    invoke-direct {v1, v0}, Lcom/google/android/libraries/places/internal/ea;-><init>(Lcom/google/android/libraries/places/internal/dl;)V
