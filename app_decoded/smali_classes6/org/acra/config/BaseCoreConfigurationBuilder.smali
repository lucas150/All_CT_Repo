...
# instance fields
.field private final configurationBuilders:Ljava/util/List;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lorg/acra/config/BaseCoreConfigurationBuilder;->reportContentChanges:Ljava/util/Map;
    ...
    iput-object v0, p0, Lorg/acra/config/BaseCoreConfigurationBuilder;->configurationBuilders:Ljava/util/List;

    .line 50
    const-class v0, Lorg/acra/config/ConfigurationBuilderFactory;
    ...
    const-string v5, "Discovered and loaded plugin of type "
    ...
    const-string v6, "BuilderFactory"
    ...
    .line 54
    :cond_0
    iget-object v2, p0, Lorg/acra/config/BaseCoreConfigurationBuilder;->configurationBuilders:Ljava/util/List;

    invoke-interface {v1, p1}, Lorg/acra/config/ConfigurationBuilderFactory;->create(Landroid/content/Context;)Lorg/acra/config/ConfigurationBuilder;
    ...
    const-string v4, "Unable to load ConfigurationBuilderFactory"
...
.method static synthetic lambda$getPluginConfigurationBuilder$0(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    .locals 0
...
.method public getPluginConfigurationBuilder(Ljava/lang/Class;)Lorg/acra/config/ConfigurationBuilder;
    ...
    .line 112
    iget-object v0, p0, Lorg/acra/config/BaseCoreConfigurationBuilder;->configurationBuilders:Ljava/util/List;
    ...
    .line 120
    new-instance v0, Lorg/acra/config/BaseCoreConfigurationBuilder$$ExternalSyntheticLambda0;

    invoke-direct {v0}, Lorg/acra/config/BaseCoreConfigurationBuilder$$ExternalSyntheticLambda0;-><init>()V
    ...
    const-string v1, " is not a registered ConfigurationBuilder"
...
.method preBuild()V
    ...
    iput-object v0, p0, Lorg/acra/config/BaseCoreConfigurationBuilder;->configurations:Ljava/util/List;
    ...
    .line 65
    iget-object v2, p0, Lorg/acra/config/BaseCoreConfigurationBuilder;->configurations:Ljava/util/List;

    invoke-interface {v1}, Lorg/acra/config/ConfigurationBuilder;->build()Lorg/acra/config/Configuration;
...
.method public setReportField(Lorg/acra/ReportField;Z)V
    .locals 1
...
.method transformReportContent([Lorg/acra/ReportField;)Ljava/util/Set;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    .line 78
    :cond_2
    sget-object p1, Lorg/acra/ACRAConstants;->DEFAULT_REPORT_FIELDS:[Lorg/acra/ReportField;
