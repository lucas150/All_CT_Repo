...
public class new_main extends AppCompatActivity implements CTInboxListener, DisplayUnitListener {
...
//                        break; // Load only the first valid unit
        ...
        Button btnSignedCall = findViewById(R.id.btnSignedCall);
...
//                showToast("Event pushed: " + currentContent);
        ...
        btnCTID.setOnClickListener(v -> {
            clevertapDefaultInstance.getCleverTapID(CTID -> {
                AlertDialog.Builder builder = new AlertDialog.Builder(new_main.this);
                ...
                builder.setTitle("CleverTap ID")
                        ...
                        .setPositiveButton("Copy", (dialog, which) -> {
                            ...
                            Toast.makeText(new_main.this, "CT ID copied to clipboard", Toast.LENGTH_SHORT).show();
        ...
        btnPushTemplates.setOnClickListener(v -> {
            Intent intent = new Intent(new_main.this,PushTemplatesActivity.class);
        ...
        btnCustomInbox.setOnClickListener(v -> {
            Intent intent = new Intent(new_main.this,CustomInbox.class);
            startActivity(intent);
        });

        btnInAppTemplates.setOnClickListener(v -> {
            Intent intent = new Intent(new_main.this,InApp_Templates.class);
            startActivity(intent);
        });

        btnSignedCall.setOnClickListener(v -> {
            Intent intent = new Intent(new_main.this,SignedCallAndroid.class);
            startActivity(intent);
        });
